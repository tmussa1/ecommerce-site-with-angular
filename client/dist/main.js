...
var routes = [{ path: '', component: _app_homepage_homepage_component__WEBPACK_IMPORTED_MODULE_4__["HomepageComponent"] },
    { path: 'productslist', component: _products_list_products_list_component__WEBPACK_IMPORTED_MODULE_3__["ProductsListComponent"] },
...
module.exports = "<nav class=\"navbar navbar-expand-lg navbar-dark bg-dark fixed-top\">\n    <div class=\"container\">\n      <a class=\"navbar-brand\" href=\"#\">SAMI</a>\n      <button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarResponsive\" aria-controls=\"navbarResponsive\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">\n        <span class=\"navbar-toggler-icon\"></span>\n      </button>\n      <div class=\"collapse navbar-collapse\" id=\"navbarResponsive\">\n        <ul class=\"navbar-nav ml-auto\">\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" class=\"nav-link\" routerLink=\"/\">Home</a>\n          </li>\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" class=\"nav-link\" routerLink=\"/about\">About Us</a>\n          </li>\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" class=\"nav-link\" routerLink=\"/productslist\">Products</a>\n          </li>\n          <li class=\"nav-item\">\n            <a class=\"nav-link\" class=\"nav-link\" routerLink=\"/subscribe\"> <img src=\"../assets/images/notification.jpg\" width=\"25px\" height=\"25px\"> Subscribe</a>\n          </li>\n          <li class=\"nav-item\">\n              <a class=\"nav-link\" class=\"nav-link\" routerLink=\"/cart\"><img src='../assets/images/cart.jpg' width=\"25px\" height=\"25px\">My Cart</a>\n            </li>\n        </ul>\n      </div>\n    </div>\n  </nav>\n\n<div class=\"container\">\n    <router-outlet></router-outlet>\n</div>\n\n<footer class=\"py-5 bg-dark\">\n    <div class=\"container\">\n      <p class=\"m-0 text-center text-white\">Copyright &copy; SAMI Online Store 2019</p>\n    </div>\n  </footer>\n\n\n"
...
module.exports = "<form (ngSubmit)=\"updateQuantity()\">\r\n<div class=\"container\" style=\"margin-top: 150px; margin-bottom: 150px;\">\r\n\t<table id=\"cart\" class=\"table table-hover table-condensed\">\r\n    \t\t\t\t<thead>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<th style=\"width:50%\">Product Name</th>\r\n\t\t\t\t\t\t\t<th style=\"width:10%\">Price</th>\r\n\t\t\t\t\t\t\t<th style=\"width:8%\">Quantity</th>\r\n\t\t\t\t\t\t\t<th style=\"width:22%\" class=\"text-center\">Subtotal</th>\r\n\t\t\t\t\t\t\t<th style=\"width:10%\"></th>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</thead>\r\n\t\t\t\t\t<tbody>\r\n\t\t\t\t\t\t<tr *ngFor=\"let cart of cartArray; let i=index\">\r\n\t\t\t\t\t\t\t<td data-th=\"Product\" >\r\n\t\t\t\t\t\t\t\t<div class=\"row\">\r\n\t\t\t\t\t\t\t\t\t<div class=\"col-sm-2 hidden-xs\"><img [src]=\"cart.imageUrl\" width=\"75px\" height=\"75px\" class=\"img-responsive\"/></div>\r\n\t\t\t\t\t\t\t\t\t<div class=\"col-sm-10\">\r\n\t\t\t\t\t\t\t\t\t\t<h4 class=\"nomargin\">{{cart.name}}</h4>\r\n\t\t\t\t\t\t\t\t\t\t<p>{{cart.description}}</p>\r\n\t\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t\t</div>\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t<td data-th=\"Price\">{{cart.price}}</td>\r\n\t\t\t\t\t\t\t<td data-th=\"Quantity\">\r\n\t\t\t\t\t\t\t\t<input type=\"number\" class=\"form-control text-center\" [(ngModel)]=\"cart.quantity\" name=\"quantity\" >\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t\t<td data-th=\"Subtotal\" class=\"text-center\">{{cart.subtotal}}</td>\r\n\t\t\t\t\t\t\t<td class=\"actions\" data-th=\"\">\r\n\t\t\t\t\t\t\t\t<button class=\"btn btn-info btn-sm\"><i class=\"fa fa-refresh\"></i></button>\r\n\t\t\t\t\t\t\t\t<button class=\"btn btn-danger btn-sm\"><i class=\"fa fa-trash-o\"></i></button>\t\t\t\t\t\t\t\t\r\n\t\t\t\t\t\t\t</td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</tbody>\r\n\t\t\t\t\t<tfoot>\r\n\t\t\t\t\t\t<tr class=\"visible-xs\">\r\n\t\t\t\t\t\t\t<td class=\"text-center\"><strong>Total {{totalPrice}}</strong></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t\t<tr>\r\n\t\t\t\t\t\t\t<td><a href=\"/productslist\" class=\"btn btn-warning\"><i class=\"fa fa-angle-left\"></i> Continue Shopping</a></td>\r\n\t\t\t\t\t\t\t<td colspan=\"2\" class=\"hidden-xs\"></td>\r\n\t\t\t\t\t\t\t<td class=\"hidden-xs text-center\"><strong>Total {{totalPrice}}</strong></td>\r\n\t\t\t\t\t\t\t<td><button type=\"submit\" class=\"btn btn-primary btn-block\" Style=\"width: 150px;\">Calculate Total<i class=\"fa fa-angle-right\"></i></button></td>\r\n\t\t\t\t\t\t</tr>\r\n\t\t\t\t\t</tfoot>\r\n\t\t\t\t</table>\r\n</div>\r\n</form>\r\n\r\n<div class=\"row\" style=\"margin-bottom: 200px;\">\r\n\t\t<div class=\"col-sm-12 text-center\">\r\n\t\t\t <button class=\"btn btn-danger btn-md center-block\" Style=\"width: 150px;\" (click)=\"removeItems()\" >Empty My Cart</button>\r\n\t\t\t <div class=\"divider\" style=\" width:800px; height:auto; display:inline-block;\"></div>\r\n\t\t\t <button class=\"btn btn-success btn-md center-block\" Style=\"width: 100px;\" (click)=\"checkOut()\" >Check Out </button>\r\n\t\t </div>\r\n</div>\r\n"
...
var ProductDetailsComponent = /** @class */ (function () {
    ...
    ProductDetailsComponent.prototype.updateQuantity = function () {
        this.calculateTotal();
    };
    ...
    ProductDetailsComponent.prototype.checkOut = function () {
...
module.exports = __webpack_require__(/*! C:\Users\Tofik Mussa\Desktop\MS in CS\CSCI E-31\E31-Projects\assignment-7\client\src\main.ts */"./src/main.ts");
